...
The {MSanalyzeNOM} package uses the get_elemental_ratios() function to compute H/C and O/C ratios. The desired numerator and denominator (usually C) are passed to the function to create a new column with the desired ratio (e.g., "HtoC").
