...
The elemental class (e.g., CHO or CHNOS) is useful for examining the assigned formulas based on their elemental content. For the default element list, the ** function assigns elemental classes to the assigned formulas.
...
If the highly abundant formulas are known  (e.g., linear alkylbenzene sulfonate surfactants), the van Krevelen diagram can be re-plotted without them as long as the figure is appropriately annotated. In the preceding figure, the two most abundant compounds appear to be linear alkylbenzene sulfonate (LAS) surfactants, and the next two most abundant appear to be stearic and palmitic acids. All of them are common laboratory contaminants. 
